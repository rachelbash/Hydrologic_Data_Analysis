...
#I tried for about an hour to do a loop or lapply table, but could not get it


filter(LAGOStrophic, trophic.class == "Oligotrophic") %>%
  count(name="Oligotrophic")
filter(LAGOStrophic, trophic.class.secchi == "Oligotrophic") %>%
  count(name="Oligotrophic")
filter(LAGOStrophic, trophic.class.tp == "Oligotrophic") %>%
  count(name="Oligotrophic")

Oligotrophic <- c(3298,16110,19861)

filter(LAGOStrophic, trophic.class == "Mesotrophic") %>%
  count(name="Mesotrophic")
filter(LAGOStrophic, trophic.class.secchi == "Mesotrophic") %>%
  count(name="Mesotrophic")
filter(LAGOStrophic, trophic.class.tp == "Mesotrophic") %>%
  count(name="Mesotrophic")

Mesotrophic <- c(15413,25083,23023)

filter(LAGOStrophic, trophic.class == "Eutrophic") %>%
  count(name="Eutrophic")
filter(LAGOStrophic, trophic.class.secchi == "Eutrophic") %>%
  count(name="Eutrophic")
filter(LAGOStrophic, trophic.class.tp == "Eutrophic") %>%
  count(name="Eutrophic")

Eutrophic <- c(41861,28659,24839)

filter(LAGOStrophic, trophic.class == "Hypereutrophic") %>%
  count(name="Hypereutrophic")
filter(LAGOStrophic, trophic.class.secchi == "Hypereutrophic") %>%
  count(name="Hypereutrophic")
filter(LAGOStrophic, trophic.class.tp == "Hypereutrophic") %>%
  count(name="Hypereutrophic")

Hypereutrophic <- c(14379,5099,7228)

class.list <- data.frame(Oligotrophic, Mesotrophic, Eutrophic, Hypereutrophic, row.names=c("trophic.class", "trophic.class.secchi", "trophic.class.tp"))
...
```{r}
proportion <- class.list %>% 
  summarise(EorH = sum(Eutrophic,Hypereutrophic))
```
...
tapply(LAGOSNandP$tp,LAGOSNandP$state,median)
...
```{r}
TNstate.jitter <- ggplot(LAGOSNandP, aes(x = state, y = tn, color = samplemonth)) +
...
TPstate.jitter <- ggplot(LAGOSNandP, aes(x = state, y = tp, color = samplemonth)) +
  geom_jitter(alpha = 0.3) +
