...
area.plot <- ggplot(MEsecchi.spatial) +
  geom_point(aes(x=secchi.mean, y=log(area))) +
  labs(x="Mean Secchi Depth (m)", y=expression("log of Lake Area (m"^2*")"))
print(area.plot)

#plot secchi depth vs lake depth
depth.plot <- ggplot(MEsecchi.spatial) +
  geom_point(aes(x=secchi.mean, y=depth)) +
  labs(x="Mean Secchi Depth (m)", y= "Depth of Lake (m)")
print(depth.plot)
