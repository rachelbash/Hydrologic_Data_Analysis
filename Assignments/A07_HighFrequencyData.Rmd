...
linearinterpolation <- as.data.frame(approx(Kansas.skinny, n = 119, method = "linear"))
...
> During this time period, 67.9% of total water exited as baseflow, while 32.1% of total water exited as quickflow.
...
> In this situation, the larger river caused a larger percentage of the total water to come from base flow. This makes sense, as it would be harder for a large river to be supported by a large amount of rain over an extended period of time.
...
> Multiple tributaries probably smooth out the results and contribute to a steadier baseflow rate that is regularly being brought down the stream. Even if one tributary may be in a drought or may experience a large storm, it would have a small effect on the larger river because of the multiple inputs to the river.
