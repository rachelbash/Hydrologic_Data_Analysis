...
> In this situation, the larger river caused a the majority of the total water to come from base flow. This makes sense, as it would be harder for a large river to be supported by a large amount of rain over an extended period of time.
