...
> Counter-Clockwise behavior where concentration decreases at the beginning of the storm (diluting) and then overtime increases concentration at the end of the storm. Slopes of the rising (quickflow) and falling limbs (baseflow) are different because they are coming from different sources that have different speeds at which they arrive at the river. Quickflow has lower concentrations of nitrate than in baseflow.
