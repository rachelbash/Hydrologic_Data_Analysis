...
```{r}
mutate(EnoDischarge, metric_Discharge = Discharge*0.0283168)
EnoDischarge$metric_Discharge <- EnoDischarge$Discharge*0.0283168
...
```{r}
mutate(EnoDischarge, rolling_mean = rollmean(x=metric_Discharge,k=30))
EnoDischarge$Rolling_mean <- rollmean(metric_Discharge,30)
```
