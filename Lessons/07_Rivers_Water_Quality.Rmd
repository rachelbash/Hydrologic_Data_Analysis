...
> If these are at extreme quantities, they have have an impact on the ecosystem in a negative way.

What types of disturbances can impact these parameters?

> Non-point and point source pollution, HABs, 
...
> More data for Kanawha river. Specific conductance is lower in Twelvepole Creek

Why might mining be causing the changes you see?

> Kanawha River has mining, which caused SpC to decrease and normalize a bit and caused pH to increase
...
> Every ten days. Too much work to do daily values
...
> There is a significant difference in means between the Pre and Post SpC values
...
> Points because it shows that there is a clear absense of data between 1960 and 1967 that the line didn't show clearly.

EPA drinking water standards for Manganese are 0.05 *_mg/L_*. How does the Kanawha stack up?

> NOT good. That converts to 50 micrograms per liter. Almost all points are above 50.
